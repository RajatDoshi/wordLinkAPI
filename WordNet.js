...
// };
WordNet.prototype.synsets = function(query, callback) {
  var request = {'label': query, 'partOf': 'sofa'};
  return _.ajax({
    type: 'POST',
    url: Constants.baseUrl + '/wordlink/sortByCategory',
    dataType: 'json',
...
// WordNet.prototype.syn = function(query) {
//   var request = {'label': query, 'partOf': 'cabinet'};
//   return _.ajax({
//     type: 'POST',
//     url: Constants.baseUrl + '/wordlink/sortByCategory',
//     dataType: 'json',
...
//     data: JSON.stringify(request),
//     callback: function(error, results){
//       console.log("Gloss", error, results)
//     }
//   });
// }
...
/*
code for determining the product of these two vectors
this allows for the coder to understand it better
/**
